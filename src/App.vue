...
const cards = [
  {
    ...
    input: 'https://github.com/user-attachments/files/17408451/input1.txt',
  ...
  },
  {
    ...
    input: 'https://github.com/user-attachments/files/17408455/input2.txt',
    answer: 'd0000d',
    rate: '5/10',
  ...
  },
  {
    ...
    input: 'https://github.com/user-attachments/files/17408460/input4.txt',
    answer: '321',
    rate: '5/10',
    hint: 'Có màu xanh',
    value: 'N',
  },
  {
    ...
    input: 'https://github.com/user-attachments/files/17408462/input5.txt',
    answer: '195153719200',
    rate: '4/10',
    hint: 'Bình dân',
    value: 'H',
  },
  {
    ...
    input: 'https://github.com/user-attachments/files/17408464/input6.txt',
    answer: '6927',
    rate: '3/10',
    hint: 'Có màu trắng',
    value: 'O',
